    ...
    return (
            <div className="navbar bg-base-100 fixed z-10 overflow-hidden max-w-7xl top-0">
                <div className="navbar-start ">
                    ...
                    <NavLink
                        to='/'
                        className="btn btn-ghost text-xl md:text-3xl font-bold">Book Vibe</NavLink>
                </div>
                ...
                <div className="navbar-end  gap-6">
                    <a className="btn bg-gradient-to-r from-[#7E90FE] to-[#9873FF] text-white">Sign In</a>
                    <a className="btn bg-gradient-to-r from-[#7E90FE] to-[#9873FF] text-white">Sign Up</a>
                </div>
            </div>
    );
};
